...
\subsection{\textquestiondown Qué es un algoritmo?}
...
\subsection{\textquestiondown Como programar algoritmos?}
...
\subsection{\\textquestiondown Que lenguajes de programaci\'on usar?}
...
\subsection{Bibliotecas y cabeceras}
...
\begin{frame}{Bibliotecas}
    Una biblioteca o libreria podriamos considerarla una colecci\'on de cabeceras, adem\'as de cabeceras incluyes archivos de enlazado din\'amico o est\'atico.
\end{frame}
...
\begin{frame}{elif}
    \begin{itemize}
        \item En Python no existe pero se puede hacer con diccionarios o concatenando m\'ultiples \textbf{if else}
...
\subsection{Declaraci\'on y Recorrido}

\begin{frame}{Declaraci\'on}
    \begin{itemize}
            \item Hay que indicar el tipo de dato y el tamaño
            \item a
            \item Su espacio en memoria var\'ia seg\'un el tipo de dato y los valores que pueda tener
            \item En Python como tal no existen,  se usan las listas en su lugar
        \end{itemize}
