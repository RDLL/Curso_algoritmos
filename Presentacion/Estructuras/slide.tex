...
\begin{frame}{Almacenamiento en memoria}
    \begin{tikzpicture}[
    	...
    	\matrix (mtr) [ampersand replacement=\&,2d-arr] {
    		2 & 1 & 1 & |[fill=orange!30]| 1 & |[fill=orange!30]| 0 & |[fill=orange!30]| 0 & 0\\
    	...
    	\matrix (K) [ampersand replacement=\&,2d-arr, right=0.2em of str, nodes={draw, fill=teal!30}] {
    		1 & 0 & 1 \\
    		0 & 1 & 0 \\
    		1 & 0 & 1 \\
    	};
    	...
    	\matrix (ret) [ampersand replacement=\&,2d-arr, right=0.2em of eq] {
