...
\begin{frame}{Eliminar}
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Por valor
		\end{itemize}
		\animategraphics[autoplay,loop,width=4cm]{70}{animaciones/array/elimination/elimination-}{0}{194}
		\animategraphics[autoplay,loop,width=4cm]{70}{"animaciones/array/elimination_value/"elimination_value-}{0}{149}
		\animategraphics[autoplay,loop,width=4cm]{70}{animaciones/array/drop/drop-}{0}{194}
	\end{itemize}
