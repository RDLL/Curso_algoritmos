...
\begin{frame}{Inserci\'on al inicio}
	...
	\end{itemize}
	\centering
	\animategraphics[autoplay,loop,width=3cm]{10}{animaciones/Estructuras/listas/simples/insertion/atbegin/begin-}{0}{89}
\end{frame}
...
\begin{frame}{Inserci\'on al final}
	...
	\end{itemize}
	\centering
	\animategraphics[autoplay,loop,width=3cm]{10}{animaciones/Estructuras/listas/simples/insertion/end/end-}{0}{89}
\end{frame}
